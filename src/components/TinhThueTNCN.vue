<template>
    <div id="personal-income-tax">
        ...
        <div class="container">
            <div class="col-md-12">
                <div class="box-white">
                    <h1 class="title--header">Công cụ tính Thuế thu nhập cá nhân chuẩn 2024</h1>
                    <div class="box-gray box--description d-flex">
                        <span class="description--icon"><i class="fa fa-circle-info"></i></span>
                    ...
                    <div v-if="showResult">
                        ...
                        <div class="form-email text-center" style="margin-top: 40px;">
                            <hr style="margin-top: 40px;margin-bottom: 15px;">
                                ...
                                <div  class="input-data submit-email" style="min-width: 250px;">
