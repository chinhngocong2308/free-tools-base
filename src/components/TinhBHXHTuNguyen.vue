<template>
  <main class="main" id="site-content" v-if="renderComponent">
    <div class="main-content">
      <section class="section-thue section-bhxh">
        <div class="block">
          ...
          <div class="tabs-bhxh">
            <a
              href="/tinh-bhxh-bat-buoc"
              title="BHXH bắt buộc"
              class="tabs-bhxh-item"
              >BHXH bắt buộc</a
            >
            <a
              href="/tinh-bhxh-tu-nguyen"
              title="BHXH tự nguyện"
              class="tabs-bhxh-item active"
              >BHXH tự nguyện</a
            >
            <a
              href="/tinh-bhxh-bat-buoc-va-tu-nguyen"
              title="Cả BHXH bắt buộc &amp; BHXH tự nguyện"
              class="tabs-bhxh-item"
          ...
          <div class="bhxhtn">
            ...
            <div id="6w8xviuqf9">
              <div class="table-group 881nvuiumu">
                <span
                  class="button ic iconlvn-c-info icerror"
                  style="display: none"
                ></span>
                ...
                <div class="table-cell m-cell5">
                  <input
                    class="input select36 fixwcel 1236il9bpn"
                    placeholder="Mức thu nhập đóng BHXH"
                  />
                </div>
                <div class="table-cell m-cell5">
                  <select
                    class="select select36 fixwcel khkipy9982"
                    disabled=""
                  >
                    <option value="1">Hộ nghèo</option>
                    <option value="2">Hộ cận nghèo</option>
                    <option value="3">Đối tượng khác</option>
                  </select>
                  <a
                    href="javascript:void(0)"
                    rel="nofollow"
                    data-toggle-target="#xoa-giaidoan-target"
                    class="ic icon-binlvn del-row fix-m-ps"
                    title="Xóa giai đoạn nộp BHXH"
                  ></a>
                </div>
              </div>
            </div>
            <div class="table-group fixmg">
            ...
            <p class="thue-note">
              ...
              khi bắt đầu đóng bảo hiểm đến khi ngừng đóng.
            </p>
            <div class="table-group2 pm1p6zqaiw" style="display: none">
              Tiền BHXH 1 lần được nhận:
              <span class="color-red">493.578.745 đồng</span>
            </div>
          </div>
        </div>
        ...
        <div class="section-content">
            ...
            <div class="thue-content 8gwrvbfe29">
                ...
                <div class="fix-xemthem lpwjzzzzne" style="display:none"><span class="btnxemthem">Xem thêm</span></div>
            </div>
            <div class="thue-content">
                <div class="thue-title2">Mức Nhà nước hỗ trợ đóng BHXH tự nguyện</div>
                <div class="thue-body">
                    ...
                    <table class="table table-bordered text-center">
                        <tbody>
                            <tr>
                                ...
                                <td><strong>Mức Nhà nước hỗ trợ đóng BHXH tự nguyện/tháng (Từ 01/2018 - 12/2021)</strong></td>
                                <td><strong>Mức Nhà nước hỗ trợ đóng BHXH tự nguyện/tháng (Từ 01/2022 - 12/2025)</strong></td>
                            </tr>
                            <tr>
                                <td>Hộ nghèo</td>
                                <td>0,22 x 700.000 x 30%</td>
                                <td>0,22 x 1.500.000 x 30%</td>
                            </tr>
                            <tr>
                                <td>Hộ cận nghèo</td>
                                <td>0,22 x 700.000 x 25%</td>
                                <td>0,22 x 1.500.000 x 25%</td>
                            </tr>
                            <tr>
                                <td>Đối tượng khác</td>
                                <td>0,22 x 700.000 x 10%</td>
                                <td>0,22 x 1.500.000 x 10%</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
                </div>
                <div class="thue-title3">Bảng hệ số trượt giá năm 2024</div>
                <div class="body-thue">
                    <div class="m-scroll-x">
                    <table class="table table-bordered text-center">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="nili2qffst" data-y="2008">2,07</td>
                                <td class="nili2qffst" data-y="2009">1,94</td>
                                <td class="nili2qffst" data-y="2010">1,77</td>
                                <td class="nili2qffst" data-y="2011">1,5</td>
                                <td class="nili2qffst" data-y="2012">1,37</td>
                                <td class="nili2qffst" data-y="2013">1,28</td>
                                <td class="nili2qffst" data-y="2014">1,23</td>
                            </tr>
                            <tr>
                                <td><strong>Năm</strong></td>
                            ...
                            <tr>
                                <td><strong>Mức điều chỉnh</strong></td>
                                <td class="nili2qffst" data-y="2015">1,23</td>
                                <td class="nili2qffst" data-y="2016">1,19</td>
                                <td class="nili2qffst" data-y="2017">1,15</td>
                                <td class="nili2qffst" data-y="2018">1,11</td>
                                <td class="nili2qffst" data-y="2019">1,08</td>
                                <td class="nili2qffst" data-y="2020">1,05</td>
                                <td class="nili2qffst" data-y="2021">1,03</td>
                            </tr>
                            <tr>
                                <td><strong>Năm</strong></td>
                            ...
                            <tr>
                                <td><strong>Mức điều chỉnh</strong></td>
                                <td class="nili2qffst" data-y="2022">1</td>
                                <td class="nili2qffst" data-y="2023">1</td>
                                <td class="nili2qffst" data-y="2024">1</td>
                            </tr>
                        </tbody>
                    </table>
                    </div>
      ...
      <div id="xoa-giaidoan-target" class="popup-bg target-hidden">
        <div class="popup-wrapper popup-340">
          <div class="popup-body">
            <span class="close-popup" data-toggle-target="#xoa-giaidoan-target"
              ><i class="iconlvn-remove btn-hidden-popup"></i
            ></span>
            <div class="popup-content popup-height">
              <div class="form-control pad16-24">
                <div class="form-group text-center">
                  <span class="text-20 font-bold"
                    >Bạn muốn xóa giai đoạn này?</span
                  >
                </div>
                <div class="form-group text-center">
                  <div class="btn-item">
                  ...
                  <div class="btn-item">
                    <span
                      data-toggle-target="#xoa-giaidoan-target"
                      class="btn btn-default wmvq3u48nn"
                      data-id=" 03"
                      >Xác nhận</span
                    >
                  </div>
  ...
  mounted: function () {
    $(document)
      ...
      .on("click", "[data-toggle-target]", function (e) {
        e.preventDefault();
        let self = $(this),
          target = self.attr("data-toggle-target") || self.attr("data-content");
        // #xoa-giaidoan-target
        if (
          typeof target != typeof undefined &&
          target != "#xoa-giaidoan-target"
        ) {
    ...
    $(document).on("click", ".9s56i2p4jd", function (e) {
      e.preventDefault();
      let self = $(this),
        giai_doan_parent = $("#6w8xviuqf9").first();
      if (giai_doan_parent.length > 0) {
        ...
        let yearIndex = 1975,
          text_tienluong = "lương";
        if (bhxhtunguyen) {
          yearIndex = 2008;
          text_tienluong = "thu nhập";
        }
        if (isNaN(bhxhIndex)) bhxhIndex = 1;
        else bhxhIndex++;
        let giaidoanHtml =
          '<div class="table-group 881nvuiumu">' +
    ...
    $(document).on("click", ".o9l4vf3d11", function (e) {
      e.preventDefault();
      let giai_doan_parent = $("#6w8xviuqf9").first();
      if (giai_doan_parent.length > 0) {
        let currentTime = new Date();
        let currentYear = currentTime.getFullYear();
        let el = $(".881nvuiumu:last", giai_doan_parent),
          bhxhIndex = el.find(".number").first().text();
        $(".881nvuiumu.huongthaisan", giai_doan_parent).find(".icerror").hide();
        if (
          bhxhIndex.length <= 0 ||
          isNaN(bhxhIndex) ||
          $("select.khkipy9982", el).length > 0 ||
          el.hasClass("huongthaisan")
        ) {
          let errorMsg =
            $("select.khkipy9982", el).length <= 0
              ? "Quý khách vui lòng thêm giai đoạn nộp BHXH."
              : "Quý khách vui lòng thêm giai đoạn nộp BHXH bắt buộc ngay trước giai đoạn thai sản.";
          showMessage({ messages: [errorMsg] });
          $(".881nvuiumu.huongthaisan:last", giai_doan_parent)
            .find(".icerror")
            .attr("title", errorMsg)
            .show();
          return;
    ...
    $(document).on("click", ".764s2cypn5", function (e) {
      e.preventDefault();
      let dates = [],
        listDates = [],
        mucluongbinhquan = 0,
        ...
        tongsothang = 0,
        sothangnghithaisan = 0,
        sotiennhan = 0,
        giaidoan_html = "",
        mucdong = "",
        mucchuanngheo = 700000,
        sothanghongheo = 0,
        sothanghocanngheo = 0,
        sothangdoituongkhac = 0,
        mucchuanngheogd2 = 1500000,
        sothanghongheogd2 = 0,
        sothanghocanngheogd2 = 0,
        sothangdoituongkhacgd2 = 0,
        giaidoanbatbuoc = 0,
        muchuongbhxh = 0,
        tongtiendongbhxh = 0,
        tienbhxhtunguyenduochotro = 0,
        tienbhxhtunguyenduochotrogd2 = 0,
        tongtienduochotro = 0,
        tongtiendongbh = "<p>- Tổng tiền đóng BHXH = ",
        nhanuochotro_dongbhxhtunguyen = "",
      ...
      $(".881nvuiumu").each(function (i, item) {
        let fromMonth = parseInt(
            $("select.from-month option:selected", $(item)).val()
          ),
          fromYear = parseInt(
            $("select.from-year option:selected", $(item)).val()
          ),
          toMonth = parseInt(
            $("select.to-month option:selected", $(item)).val()
          ),
          ...
          doituongthamgia =
            $("select.khkipy9982", $(item)).length > 0
              ? parseInt($("select.khkipy9982 option:selected", $(item)).val())
              : 0,
          obj = {},
        ...
        if (doituongthamgia > 0) {
          //text_tienluong = 'Thu nhập';
          if (
            (fromYear > 0 && fromYear < 2008) ||
            (toYear > 0 && toYear < 2008)
          ) {
            showMessage({
              messages: [
                "Chính sách BHXH tự nguyện ra đời từ năm 2008, Quý khách vui lòng chọn thời gian từ năm 2008 trở về sau.",
              ],
            });
            dates = [];
            return false;
        ...
        if (i == 0 && huongthaisan) {
          showMessage({
            messages: ["Quý khách vui lòng thêm giai đoạn nộp BHXH."],
          });
          dates = [];
          $(item)
            .find(".icerror")
            .attr("title", "Quý khách vui lòng thêm giai đoạn nộp BHXH.")
            .show();
          return false;
        }
          ...
          if (listDates[listDates.length - 1] >= dateFrom) {
            showMessage({
              messages: [
                ...
                `Vui lòng chọn thời gian lớn hơn tháng ${
                  (listDates[listDates.length - 1].getMonth() + 1 < 10
                    ? "0"
                    : "") +
                  (listDates[listDates.length - 1].getMonth() + 1)
                } năm ${listDates[listDates.length - 1].getFullYear()}.`,
              ],
            });
            dates = [];
            $(item)
              ...
              .attr(
                "title",
                "Ngày chọn không hợp lệ! Vui lòng chọn thời gian lớn hơn tháng " +
                  ((listDates[listDates.length - 1].getMonth() + 1 < 10
                    ? "0"
                    : "") +
                    (listDates[listDates.length - 1].getMonth() + 1)) +
                  " năm " +
                  listDates[listDates.length - 1].getFullYear() +
                  "."
              )
              .show();
            return false;
        ...
        if (i < $(".881nvuiumu").length - 1 || huongthaisan) {
          if (
            ...
            $(item)
              .find(".icerror")
              .attr("title", "Vui lòng chọn thời gian: tháng/năm.")
              .show();
            return false;
          }
          if (dateFrom > dateTo) {
        ...
        let inputEmpty = $(".1236il9bpn", $(item))
          .filter(function () {
            return !this.value;
          })
          .first();
        ...
        if ($(".1236il9bpn", $(item)).length > 0 && inputEmpty.length > 0) {
          showMessage({
            ...
            messages: [
              `Vui lòng nhập Mức ${text_tienluong.toLowerCase()} đóng BHXH!`,
            ],
          });
          dates = [];
          $(inputEmpty)
      ...
      if (dates.length > 0) {
        for (let i = 0; i < dates.length; i++) {
          ...
          if (
            dates[i].doituongthamgia > 0 &&
            dates[i].year >= 2018 &&
            dates[i].year <= 2021
          ) {
            //số tháng nhà nước hỗ trợ đóng BHXH tự nguyện từ 01/01/2018
          ...
          if (
            ...
            //số tháng nhà nước hỗ trợ đóng BHXH tự nguyện từ 01/01/2022
            if (dates[i].doituongthamgia == 1) {
          ...
          let mucdongtheogiaidoan = Math.round(
            dates[i].totalMonths *
              dates[i].mucdong *
          ...
          giaidoan_html +=
            "<p>- Giai đoạn đóng từ T" +
            dates[i].fromMonth +
            "/" +
            dates[i].year +
            " đến T" +
            (dates[i].fromMonth + dates[i].totalMonths - 1) +
            "/" +
            dates[i].year;
          ...
          if (dates[i].huongthaisan) {
            ...
            giaidoan_html +=
              "<p>(Mức tiền lương đóng BHXH của thời gian nghỉ thai sản là mức tiền lương đóng BHXH của tháng trước khi nghỉ hưởng chế độ)</p>";
          } else {
            giaidoan_html +=
              "- Mức " +
              text_tienluong.toLowerCase() +
              " đóng BHXH: " +
              formatNumber(dates[i].mucdong, ".", ".") +
              " đồng</p>";
          }
          giaidoan_html +=
            ...
            dates[i].totalMonths +
            " = " +
            formatNumber(mucdongtheogiaidoan, ".", ".") +
            " đồng</p>";
          tongtiendongbh +=
            formatNumber(mucdongtheogiaidoan, ".", ".") +
            (i < dates.length - 1 ? " + " : "");
        ...
        tongtiendongbh +=
          " = " + formatNumber(mucluongbinhquan, ".", ".") + " đồng</p>";
        ...
        for (let n = 0; n < sothangnghitstheogiaidoan.length; n++) {
          if (
            sothangnghitstheogiaidoan[n].sothangnghithaisan > 0 &&
            (sothangnghitstheogiaidoan[n].sothangnghithaisan < 4 ||
              sothangnghitstheogiaidoan[n].sothangnghithaisan > 6)
          ) {
            let giaidoants_err = $(".881nvuiumu.huongthaisan")
              .filter(function () {
                let fMonth = parseInt(
                    $("select.from-month option:selected", $(this)).val()
                  ),
                  fYear = parseInt(
                    $("select.from-year option:selected", $(this)).val()
                  ),
                  tMonth = parseInt(
                    $("select.to-month option:selected", $(this)).val()
                  ),
                  tYear = parseInt(
                    $("select.to-year option:selected", $(this)).val()
                  );
                return (
                  fMonth + "/" + fYear + "-" + tMonth + "/" + tYear ==
                  sothangnghitstheogiaidoan[n].giaidoan
                );
              })
              .first();
            ...
            if (giaidoants_err.length > 0) {
              showMessage({
                messages: [
                  `Thời gian nghỉ thai sản không ${
                    sothangnghithaisan < 4
                      ? "đủ 4 tháng."
                      : "được vượt quá 6 tháng."
                  }`,
                ],
              });
              $(".pm1p6zqaiw > span").text("");
        ...
        if (
          ...
          nhanuochotro_dongbhxhtunguyen +=
            nhanuochotro_dongbhxhtunguyen == ""
              ? "<p>Số tiền Nhà nước hỗ trợ đóng BHXH:</p><p>(Nhà nước bắt đầu hỗ trợ đóng BHXH tự nguyện từ 01/01/2018)</p>"
              : "";
        }
        ...
        if (
          ...
          nhanuochotro_dongbhxhtunguyen +=
            "<p>Số tiền Nhà nước hỗ trợ đóng BHXH tự nguyện từ tháng 01/2018 - hết tháng 12/2021</p>";
          if (sothanghongheo > 0) {
            phantramhotro = 30;
            tienhotro = 0.22 * mucchuanngheo * 0.3 * sothanghongheo;
            tienbhxhtunguyenduochotro += tienhotro;
            nhanuochotro_dongbhxhtunguyen +=
              '<p style="padding-left:45px;">0.22 x ' +
              formatNumber(mucchuanngheo, ".", ".") +
              " x " +
              phantramhotro +
              "% x " +
              sothanghongheo +
              " tháng = " +
              formatNumber(tienhotro, ".", ".") +
              " đồng</p>";
            if (sothanghocanngheo > 0 || sothangdoituongkhac > 0)
              nhanuochotro_dongbhxhtunguyen +=
                '<p style="float:left;padding-left:30px;">+ </p>';
          }
          ...
          if (
            (sothanghongheo > 0 && sothanghocanngheo > 0) ||
            (sothanghongheo > 0 && sothangdoituongkhac > 0) ||
            (sothanghocanngheo > 0 && sothangdoituongkhac > 0)
          )
            nhanuochotro_dongbhxhtunguyen +=
              '<p style="padding-left:30px;"> = &nbsp;' +
              formatNumber(tienbhxhtunguyenduochotro, ".", ".") +
              " đồng</p>";
        ...
        if (
          ...
          let phantramhotro = 0,
            tienhotro = 0;
          nhanuochotro_dongbhxhtunguyen +=
            "<p>Số tiền Nhà nước hỗ trợ đóng BHXH tự nguyện từ tháng 01/2022 - hết tháng 12/2025</p>";
          ...
          if (sothangdoituongkhacgd2 > 0) {
            ...
            nhanuochotro_dongbhxhtunguyen +=
              ...
              phantramhotro +
              "% x " +
              sothangdoituongkhacgd2 +
              " tháng = " +
              formatNumber(tienhotro, ".", ".") +
              " đồng</p>";
          }
          if (
            (sothanghongheogd2 > 0 && sothanghocanngheogd2 > 0) ||
            (sothanghongheogd2 > 0 && sothangdoituongkhacgd2 > 0) ||
            (sothanghocanngheogd2 > 0 && sothangdoituongkhacgd2 > 0)
          )
            nhanuochotro_dongbhxhtunguyen +=
              '<p style="padding-left:30px;"> = &nbsp;' +
              formatNumber(tienbhxhtunguyenduochotrogd2, ".", ".") +
              " đồng</p>";
          sotiennhan = sotiennhan - tienbhxhtunguyenduochotro;
        }
        ...
        if (tienbhxhtunguyenduochotro > 0 || tienbhxhtunguyenduochotrogd2) {
          tongtienduochotro =
            tienbhxhtunguyenduochotro + tienbhxhtunguyenduochotrogd2;
          if (
            tienbhxhtunguyenduochotro > 0 &&
            tienbhxhtunguyenduochotrogd2 > 0
          ) {
            nhanuochotro_dongbhxhtunguyen +=
              "<p>Tổng số tiền nhà nước hỗ trợ đóng BHXH = " +
              formatNumber(tienbhxhtunguyenduochotro, ".", ".") +
              " + " +
              formatNumber(tienbhxhtunguyenduochotrogd2, ".", ".") +
              " = " +
        ...
        let k = 0,
          z = 0,
          thoigianthamgiabhxh = function (thang) {
            let y = Math.floor(thang / 12),
              m = thang % 12;
            return (
              (y > 0 ? (y < 10 ? "0" : "") + y + " năm" : "") +
              (m > 0 ? " " + m + " tháng" : "")
        ...
        if (tongsothang < 12) {
          ...
          this.htmlResultlet =
            "<p>1. Thời gian tham gia BHXH: " +
            thoigianthamgiabhxh(tongsothang) +
            " </p>";
          ...
          this.htmlResultlet +=
            "<p>2. " +
            text_tienluong +
            " đóng BHXH của các giai đoạn tham gia BHXH như sau:</p>" +
            giaidoan_html;
          this.htmlResultlet += tongtiendongbh;
          this.htmlResultlet +=
            "<p> Mức bình quân " +
            text_tienluong.toLowerCase() +
            " đóng BHXH = Tổng tiền / tổng số tháng = " +
            formatNumber(mucluongbinhquan, ".", ".") +
            " đồng</p>";
          if (
            !$(this).hasClass("bhxhtunguyen") &&
            !$(this).hasClass("bhxhbatbuocvatunguyen")
          ) {
            if (loaimuchuongbhxh == 1) {
              this.htmlResultlet +=
                "<p>3. Mức hưởng BHXH một lần = 22% x Tổng tiền lương đóng BHXH = 22% x " +
                formatNumber(tongtiendongbhxh, ".", ".") +
                " = " +
                formatNumber(muchuongbhxh, ".", ".") +
                " đồng</p>";
            } else {
              this.htmlResultlet +=
                "<p>3. Mức hưởng BHXH một lần = 22% x Tổng tiền lương đóng BHXH = <b>22% x " +
                formatNumber(tongtiendongbhxh, ".", ".") +
                " = " +
                formatNumber(muchuongbhxh, ".", ".") +
                " đồng</b></p>";
            ...
            this.htmlResultlet +=
              "<p>Mức hưởng BHXH 1 lần với toàn thời gian đóng = 22% x Tổng thu nhập đóng BHXH = 22% x " +
              formatNumber(tongtiendongbhxh, ".", ".") +
              " = " +
              formatNumber(muchuongbhxh, ".", ".") +
              " đồng</p>";
          ...
          if (sothangdongtruoc2014 > 0 && sothangdongtu2014 > 0) {
            if (
              ...
              if (loaimuchuongbhxh == 1) {
                ...
                this.htmlResultlet +=
                  "<p>Tiền BHXH 1 lần được nhận = <strong>" +
                  formatNumber(muchuongbhxh, ".", ".") +
                  (tienbhxhtunguyenduochotro > 0
                    ? " - " + formatNumber(tienbhxhtunguyenduochotro, ".", ".")
                    : "") +
            ...
            if (loaimuchuongbhxh == 1) {
              ...
              this.htmlResultlet +=
                "<p>Do mức hưởng BHXH 1 lần tối đa của người đóng dưới 1 năm bằng 02 tháng mức bình quân tiền lương đóng BHXH nên:</p>";
              this.htmlResultlet +=
                "<p>Số tiền BHXH 1 lần được nhận = 2 x Mức bình quân tiền lương đóng BHXH = <b>2 x " +
                formatNumber(mucluongbinhquan, ".", ".") +
                " = " +
                formatNumber(sotiennhan, ".", ".") +
                " đồng</b></p>";
            ...
            this.htmlResultlet +=
              '<p><em><strong class="colorred">*Lưu ý:</strong> BHXH 1 lần đã được tính hệ số trượt giá</em></p>';
              ...
              if (loaimuchuongbhxh == 1) {
                if (tongtienduochotro > 0) {
                  this.htmlResultlet +=
                    ...
                    formatNumber(muchuongbhxh, ".", ".") +
                    (tongtienduochotro > 0
                      ? " - " + formatNumber(tongtienduochotro, ".", ".")
                      : "") +
                    (tongtienduochotro > 0
                      ? " = " + formatNumber(sotiennhan, ".", ".")
                      : "") +
          ...
          if (sothangdongtruoc2014_ > 0) {
            this.htmlResultlet +=
              "<p>- Thời gian tham gia BHXH trước năm 2014: " +
              thoigianthamgiabhxh(sothangdongtruoc2014_) +
              "</p>";
          }
          if (sothangdongtu2014_ > 0) {
            this.htmlResultlet +=
              "<p>- Thời gian tham gia BHXH từ năm 2014 trở đi: " +
              thoigianthamgiabhxh(sothangdongtu2014_) +
              "</p>";
          }
          this.htmlResultlet +=
            "<p>2. Mức bình quân " +
          ...
          if (sothangdongtruoc2014 > 0) {
            ...
            sotiennhan += k;
            this.htmlResultlet +=
              '<p>Mức hưởng BHXH 1 lần đối với thời gian đóng BHXH trước 2014: </p><p style="padding-left: 45px;">' +
              formatNumber(mucluongbinhquan, ".", ".") +
              " x " +
          ...
          if (sothangdongtu2014 > 0) {
            ...
            if (thangdu > 0) {
              this.htmlResultlet +=
                "<p><i>(Số tháng lẻ đóng trước năm 2014 được chuyển sang giai đoạn từ năm 2014 trở đi)</i></p>";
            }
            this.htmlResultlet +=
              '<p style="padding-left: 45px;">' +
              formatNumber(mucluongbinhquan, ".", ".") +
          ...
          if (sothangdongtruoc2014 > 0 && sothangdongtu2014 > 0) {
            this.htmlResultlet +=
              "<p>Tổng tiền BHXH 1 lần được nhận = " +
              formatNumber(k, ".", ".") +
              " + " +
              formatNumber(z, ".", ".") +
              (tienbhxhtunguyenduochotro > 0
    ...
    $(document).on("click", ".lpwjzzzzne", function (e) {
      e.preventDefault();
    ...
    $(document).on("keypress keyup blur", "input.1236il9bpn", function (event) {
      if (event.which != 46 && (event.which < 48 || event.which > 57)) {
        event.preventDefault();
      }
      let self = $(this),
        value = self.val().replace(/^0+/g, "").replace(/\./g, "");
      self.val(formatNumber(value, ".", "."));
    });
    $(document).on("click", ".icon-binlvn.del-row", function (e) {
      e.preventDefault();
    ...
    $(document).on("click", ".btn-hidden-popup", function (e) {
      e.preventDefault();
      let element = document.getElementById("xoa-giaidoan-target");
      element.classList.remove("target-expanded");
    });

    $(document).on("click", ".wmvq3u48nn", function (e) {
      e.preventDefault();
      let element = document.getElementById("xoa-giaidoan-target");
      element.classList.remove("target-expanded");
      let self = $(this),
        id = self.attr("data-id"),
        index = self.closest(".881nvuiumu:last").find(".number").html();
      if (isNaN(index)) {
        index = 1;
      } else index++;
      if (typeof id !== "undefined") {
        let itemDelete = $(".881nvuiumu .number")
          .filter(function () {
    ...
    $(document).on("change", ".from-year, .to-year", function (e) {
      e.preventDefault();
      let self = $(this),
        parent = self.closest(".881nvuiumu"),
        y = 0;
